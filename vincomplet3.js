        ...
        function vueVin(e) {
            ...
            document.getElementById("txtregion_vue").value = valeurs[4];
            document.getElementById("txtcouleur_vue").value = valeurs[6];
            document.getElementById("txtculture_vue").value = valeurs[8];
            document.getElementById("txtcomment_vue").value = valeurs[9];
